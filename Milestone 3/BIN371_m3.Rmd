...
note this will produce a ton of empty data, don't worry about it, that's just how these things go when converted to binary, so we're just hiding the results from being printed in the pdf, otherwise it'll generate like 50 pages worth of empty data
